...
<footer class="site-footer">
  <div class="container">
    <div class="row">
      <div class="col-lg-4">
        <div class="mb-5">
          <h3 class="footer-heading mb-4">About <a href="<?php echo APPURL; ?>" class="text-white  mb-0">Qejani<span
          class="text-danger">Connect</span></a></h3></h3>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md-6 col-lg-6">
            <ul class="list-unstyled">
              ...
              <li><a href="<?php echo APPURL; ?>">Privacy Policy</a></li>
              <li><a href="<?php echo APPURL; ?>contact.php">Contact Us</a></li>
              <li><a href="<?php echo APPURL; ?>">Terms</a></li>
            </ul>
          </div>
        </div>
